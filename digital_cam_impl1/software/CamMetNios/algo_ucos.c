...
int main(void)
{
	OSInit();
	printf("hai\n");
  OSTaskCreate(taskStartGame,(void *) 0, &taskStartGame_stk[TASK_STACKSIZE-1],5);
  printf("hoi\n");
  OSStart();
  printf("hei\n");
  return 0;
...
void taskStartGame(void* pdata)
{
	OSTaskCreate(taskTest, NULL, &taskTestStack[TASK_STACKSIZE -1], 10);
